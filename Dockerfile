...
# ✅ Build testid ja jooksuta need
RUN dotnet test App.Tests/App.Tests.csproj --no-restore --verbosity normal --logger:"console;verbosity=detailed" || true

# ✅ Ainult kui testid edukad, siis publish
